...
_class("Component", EventTarget, function(_super){
	...
	this.parseInt = function(v){return this._dom.parseInt(v);};
	...
	this.getAlign = function(){return this._align;};
	...
	this.getZIndex = function(){return this._zIndex;};
	...
	this.getCapture = function(){return this._capture;};
...
_class("WindowSkinWINXP", Component, function(_super){
	...
	this.init = function(obj){
		...
		//runtime.dom.applyCssStyle(this, _css, "resizable");
	};
	this.dispose = function(){
		this._title = null;
...
_class("WindowSkinWIN2K", Component, function(_super){
	...
	this.onResizableChange = function(){
		//runtime.dom.applyCssStyle(this, _css, this._parent.getResizable() ? "resizable" : "normal");
...
_class("SysBtn", Component, function(_super){
	...
	this.init = function(obj, win, css){
		_super.init.apply(this, arguments);
		this._win = win;
		this._css = "." + this._self.className;
		this._xpath = this._win._css + " .head " + this._css;
		this._capture = false;
		this._self.onmousedown = function(ev){
...
_class("Window", Component, function(_super){
	...
	this.init = function(obj){
		...
		if(this._self.className == "wui-Window-winxp"){
