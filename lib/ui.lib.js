...
//<div id="d1" class="LineEdit">alc>window.<span class="cursor">a</span>lert("aaaa");</div>
_class("LineEdit", Component, function(_super){
	...
	*/
	...
	this.reinit = function(){
		this._text = "";
		this._col = 0;
		this.print(this._parent._prompt, "sys");
		this.setIomode("in");
	};
	this.dispose = function(){
		if(this._useInput){
	...
	this.setFocus = function(){
		if(this._useInput){
			...
			rng = null;
			var _this = this;
			window.setTimeout(function(){_this._input.focus();}, 0);
		}else{
	...
	this.do_control = function(keyCode){
		switch(keyCode){
