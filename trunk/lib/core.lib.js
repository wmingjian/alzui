...
_class("DOMUtil", "", function(_super){
	this._init = function(){
		...
		this._nodes = [];
		this._css = null;
		this._css = this.parseCss(runtime._doc.styleSheets[0].rules || runtime._doc.styleSheets[0].cssRules);
	};
...
/*#file end*/
/*#file begin=alz.core.LayoutElement.js*/
_package("alz.core");

_class("LayoutElement", "", function(_super){
